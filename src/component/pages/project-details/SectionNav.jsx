...
function SectionNav({ sections }) {
    ...
    return (
        <nav className="sticky top-24 flex flex-col pt-20 pr-6">
            ...
            <span className="font-body font-bold text-[0.85rem] tracking-primary uppercase text-black opacity-35 mb-3 pl-4">
                Contents
            </span>
            ...
            {navEntries.map(({ id, label }) => {
                ...
                return (
                    <button
                        ...
                        className={[
                            'text-left font-body text-[1.05rem] leading-snug py-[0.4rem] pl-4 mb-2',
