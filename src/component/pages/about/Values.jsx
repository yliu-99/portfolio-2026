...
const CARDS = [
  ...
  },
  {
    ...
    imgSrc: "https://i.postimg.cc/fLYJ04xR/enqi.jpg",
    imgAlt: "Yuhan's younger brother Enqi",
  },
  {
    title: "Humility",
    titleBg: "bg-black",
          ...
          {CARDS.map((card, i) => (
            ...
            >
              ...
              >
                ...
                {/* Back */}
                <div className="absolute inset-0 transform-[rotateY(180deg)] overflow-hidden border-3 border-black backface-hidden">
